...
// Renderizador que dibuja una pastilla (badge) de color dentro de una celda.
// Lo uso para mostrar el estado: stock, estado de factura, etc.
// Cada estado tiene su propio color definido en el enum que implementa la interfaz Info.
public class TableBadgeCellRenderer extends JLabel implements TableCellRenderer {
    ...
    // Registra este renderer en todas las columnas de la tabla que usan el enum dado.
